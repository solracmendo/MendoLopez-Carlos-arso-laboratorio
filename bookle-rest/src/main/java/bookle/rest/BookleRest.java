...
public class BookleRest {
	...
	public Response addDiaActividad(
			@PathParam("id") String id,
			@PathParam("fecha") Date fecha,
			 int turnos) throws BookleException{
		controlador.addDiaActividad(id, fecha, turnos);
		return Response.status(Response.Status.NO_CONTENT).build();
	}
	...
	public Response addTurnoActividad(
			@PathParam("id") String id,
			@PathParam("fecha") Date fecha) throws BookleException {
		controlador.addTurnoActividad(id, fecha);
		return Response.status(Response.Status.NO_CONTENT).build();
	}
	...
	public Response setHorario (
			@PathParam("id") String idActividad,
			@PathParam("fecha")Date fecha,
			@PathParam("turno")int indice,
			String horario)throws BookleException {
		controlador.setHorario(idActividad, fecha, indice, horario);
		return Response.status(Response.Status.NO_CONTENT).build();
	}
	...
	public Response createReserva(
			...
			@FormParam("email") String email) throws BookleException{
		String id = controlador.createReserva(idActividad, fecha, indice, alumno, email);
